...
! CH4
    ...
    call hist_addfld1d (fname='TAPPINGC', units='gC/m^2', &
            avgflag='A', long_name='tapping C', &
            ptr_pft=pcs%tappingc, default='inactive')
    ...
    call hist_addfld1d (fname='TAPPINGN', units='gN/m^2', &
            avgflag='A', long_name='tapping nitrogen', &
            ptr_pft=pns%tappingn)
...
! add by F. Li and S. Levis
 ...
 call hist_addfld1d (fname='M_LIVESTEMC_STORAGE_TO_LITTER_FIRE', units='gC/m^2/s', &
    ...
    call hist_addfld1d (fname='CPOOL_TO_TAPPINGC', units='gC/m^2/s', &
            avgflag='A', long_name='allocation to tapping C', &
            ptr_pft=pcf%cpool_to_tappingc, default='inactive')
...
! F. Li and S. Levis
   ...
   call hist_addfld1d (fname='SOMC_FIRE', units='gC/m^2/s', &
    ...
    call hist_addfld1d (fname='NPOOL_TO_TAPPINGN', units='gN/m^2/s', &
            avgflag='A', long_name='allocation to tapping N', &
            ptr_pft=pnf%npool_to_tappingn, default='inactive')
