...
!------------------------------------------------------------------------
    ...
    allocate(pcf%cpool_to_tappingc(beg:end))
...
!------------------------------------------------------------------------
   ...
   allocate(pnf%m_leafn_to_fire(beg:end))
    ...
    allocate(pnf%npool_to_tappingn(beg:end))
