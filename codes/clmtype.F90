...
type, public :: pft_cstate_type
   ...
   real(r8), pointer :: tappingc(:)           ! (gC/m2) tapping C  
...
type, public :: pft_nstate_type
   ...
   real(r8), pointer :: tappingn(:)           ! (gN/m2) tapping N
...
type, public :: pft_cflux_type
   ...
   real(r8), pointer :: cpool_to_tappingc(:)                 ! allocation to tapping C (gC/m2/s)   Ashehad Ali 
...
type, public :: pft_nflux_type
  ...
  real(r8), pointer :: m_leafn_to_litter_fire(:)       ! (gN/m2/s) from leafn to litter N  due to fire               
   ...
   real(r8), pointer :: npool_to_tappingn(:)                ! allocation to tapping N (gN/m2/s)  Ashehad Ali
   ! annual turnover of storage to transfer pools           
